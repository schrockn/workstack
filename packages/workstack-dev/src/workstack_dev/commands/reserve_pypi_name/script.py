...
@click.option(
    ...
    show_default=True,
    help="Package description stored in PyPI metadata",
)
@click.option("--dry-run", is_flag=True, help="Show operations without publishing")
@click.option("--force", is_flag=True, help="Skip confirmation prompt")
def main(name: str, description: str, dry_run: bool, force: bool) -> None:
    """Create and publish a placeholder package to reserve a PyPI name."""
