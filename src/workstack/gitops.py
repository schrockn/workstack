...
_default_git_ops = RealGitOps()


def list_worktrees(repo_root: Path) -> list[WorktreeInfo]:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.list_worktrees(repo_root)


def get_current_branch(cwd: Path) -> str | None:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.get_current_branch(cwd)


def detect_default_branch(repo_root: Path) -> str:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.detect_default_branch(repo_root)


def get_git_common_dir(cwd: Path) -> Path | None:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.get_git_common_dir(cwd)
...
def add_worktree(
    ...
    *,
    ...
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.add_worktree(
...
def move_worktree(repo_root: Path, old_path: Path, new_path: Path) -> None:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.move_worktree(repo_root, old_path, new_path)


def remove_worktree(repo_root: Path, path: Path, *, force: bool = False) -> None:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.remove_worktree(repo_root, path, force=force)


def checkout_branch(cwd: Path, branch: str) -> None:
    """Convenience function delegating to default RealGitOps singleton."""
    return _default_git_ops.checkout_branch(cwd, branch)
